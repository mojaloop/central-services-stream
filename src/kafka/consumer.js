...
class Consumer extends EventEmitter {
   ...
   */
  isConnected () {
    this._config?.logger.isSillyEnabled && this._config?.logger?.silly('Consumer::isConnected()')
   ...
   */
  connectedTime () {
    this._config?.logger.isSillyEnabled && this._config?.logger?.silly('Consumer::connectedTime()')
